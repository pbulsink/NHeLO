cleanHockeyData<-function(hockeyData){
  teamReplace<-list(
    list('Alberta Oilers', 'Edmonton Oilers'),
    list('Mighty Ducks of Anaheim', 'Anaheim Ducks'),
    list('Winnipeg Jets (historical)','Arizona Coyotes'),
    list('Phoenix Coyotes', 'Arizona Coyotes'),
    list('Atlanta Flames', 'Calgary Flames'),
    list('Atlanta Thrashers', 'Winnipeg Jets'),
    list('Toronto Toros', 'Birmingham Bulls'),
    list('Ottawa Nationals', 'Birmingham Bulls'),
    list('Quebec Athletic Club/Bulldogs','Brooklyn Americans'),
    list('Hamilton Tigers','Brooklyn Americans'),
    list('New York Americans','Brooklyn Americans'),
    list('Philadelphia Blazers','Calgary Cowboys'),
    list('Vancouver Blazers','Calgary Cowboys'),
    list('Oakland Seals','Cleveland Barons'),
    list('California Golden Seals','Cleveland Barons'),
    list('New England Whalers','Carolina Hurricanes'),
    list('Hartford Whalers','Carolina Hurricanes'),
    list('Chicago Black Hawks','Chicago Blackhawks'),
    list('Quebec Nordiques','Colorado Avalanche'),
    list('Kansas City Scouts','New Jersey Devils'),
    list('Colorado Rockies','New Jersey Devils'),
    list('Minnesota North Stars','Dallas Stars'),
    list('Detroit Cougars','Detroit Red Wings'),
    list('Detroit Falcons','Detroit Red Wings'),
    list('Los Angeles Sharks','Michigan Stags/Baltimore Blades'),
    list('New York Raiders','San Diego Mariners'),
    list('New York Golden Blades/New Jersey Knights','San Diego Mariners'),
    list('Pittsburgh Pirates','Philadelphia Quakers'),
    list('Toronto Arenas','Toronto Maple Leafs'),
    list('Toronto St. Patricks','Toronto Maple Leafs'),
  ...
  message('dropping unplayed games')
